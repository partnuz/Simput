...
class Smof_Fields_Sliderui_Field extends Smof_Fields_Parent_Field{
	...
	function enqueueStyles(){
		wp_enqueue_style( 'smof-field-sliderui', $this -> args[ 'subframework' ] -> uri[ 'fields' ] . 'sliderui/field.css'  );
	}
	
	function enqueueScripts(){
	
		wp_register_script( 'smof-field-sliderui', $this -> args[ 'subframework' ] -> uri[ 'fields' ] . 'sliderui/script.js', array( 'jquery' ) );
